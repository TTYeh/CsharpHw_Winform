...
{
    public partial class hw15_guessGuesser : Form
    {
        public static hw15_guessGuesser onlyOnceGuessForm;
        public hw15_guessGuesser()
        {
            InitializeComponent();
        ...
        private void btnEnter_Click(object sender, EventArgs e)
        {
            ...
            if (isInt) {
                ...
                // 要確定好更新數值的個體
                hw15_guessMain.formInstanceMain.labelShowMsg.Text = returnUserGuess();
        ...
        {
            string frontWord = hw15_guessMain.formInstanceMain.labelShowMsg.Text;
