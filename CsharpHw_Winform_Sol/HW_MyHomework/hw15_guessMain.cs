...
{
    public partial class hw15_guessMain : Form
    {
        public static hw15_guessMain formInstanceMain;
        public static Label labelInstanceMain;
        public hw15_guessMain()
        {
            InitializeComponent();
        ...
        private void btnGuess_Click(object sender, EventArgs e)
        {
            if (! isFormExist())
            {
                hw15_guessGuesser guesser = new hw15_guessGuesser();
                guesser.ShowDialog();
            }
            else
            {
                // TODO:讓已經存在的視窗閃兩下
                hw15_guessGuesser.onlyOnceGuessForm.TopMost = true;
